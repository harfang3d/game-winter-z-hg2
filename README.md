...
1. Get HARFANG 3D
	1. Either download it from the [HARFANG website](https://www.harfang3d.com/releases/1.2.0/) and follow the [install instructions](https://www.harfang3d.com/docs/2.0.111/man.cpython/)
	1. Or, using PIP in the command line, type '*pip install -Iv harfang==1.2.0*'
1. Clone/download this repository
1. run *main.py*

### Lua
1. Get [HARFANG 3D for Lua](https://www.harfang3d.com/releases/1.2.0/)
1. Clone/download this repository
